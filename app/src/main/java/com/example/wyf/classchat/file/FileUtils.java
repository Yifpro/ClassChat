package com.example.wyf.classchat.file;
...
public class FileUtils {
    ...
    public static int getFileIconByPath(String path){
        path = path.toLowerCase();
        int iconId = R.drawable.ic_file_what;
        if (path.endsWith(".txt")){
            iconId = R.drawable.ic_file_txt;
        }else if(path.endsWith(".doc") || path.endsWith(".docx")){
            iconId = R.drawable.ic_file_doc;
        }else if(path.endsWith(".xls") || path.endsWith(".xlsx")){
            iconId = R.drawable.ic_file_xls;
        }else if(path.endsWith(".ppt") || path.endsWith(".pptx")){
            iconId = R.drawable.ic_file_ppt;
        }else if(path.endsWith(".xml")){
            iconId = R.drawable.ic_file_xml;
        }else if(path.endsWith(".htm") || path.endsWith(".html")){
            iconId = R.drawable.ic_file_html;
        }
        return iconId;
    }
