...
public class EmotionKeyboard {
    ...
    private OnClickExpressionBtnListener listener;
    ...
    private void showEmotionLayout() {
        ...
        mEmotionLayout.postDelayed(() -> {
            mEmotionLayout.getLayoutParams().height = finalSoftInputHeight;
...
//	        params.weight = 0.0F;
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(mContentView.getLayoutParams());
...
//	        }, 200L);
    ...
    private int getSupportSoftInputHeight() {
        ...
        if (softInputHeight < 0) {
            Log.e("EmotionKey", "EmotionKeyboard--Warning: value of softInputHeight is below zero!");
        }
        //存一份到本地
        if (softInputHeight > 0) {
    ...
    public EmotionKeyboard setOnClickExpressionBtnListener(OnClickExpressionBtnListener listener) {
        this.listener = listener;
        return this;
    }

    public interface OnClickExpressionBtnListener {
