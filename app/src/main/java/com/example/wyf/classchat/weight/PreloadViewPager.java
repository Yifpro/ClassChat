...
public class PreloadViewPager extends ViewGroup {
    //private static final String TAG = "<span style="font-family:Arial, Helvetica, sans-serif;">NoPreLoadViewPager</span>";
    private static final String TAG = PreloadViewPager.class.getSimpleName();
    private static final boolean DEBUG = false;

    private static final boolean USE_CACHE = false;

    private static final int DEFAULT_OFFSCREEN_PAGES = 2;//默认是1
    ...
    public PreloadViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
